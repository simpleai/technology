...
public enum JsonMapper {
    ...
    private JsonMapper() {
        ...
        timeModule.addDeserializer(LocalDateTime.class, new com.xiaoruiit.knowledge.point.utils.LocalDateTimeDeserializer());
        timeModule.addSerializer(LocalDateTime.class, new com.xiaoruiit.knowledge.point.utils.LocalDateTimeSerializer());
